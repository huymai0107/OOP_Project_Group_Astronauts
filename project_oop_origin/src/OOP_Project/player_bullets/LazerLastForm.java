...
public class LazerLastForm extends PlayerWeaponType{

	private Rectangle bullet;
	private final double speed = 3d;
	
	public LazerLastForm(double xPos, double yPos){
		this.setxPos(xPos);
		this.setyPos(yPos);
	...
	public void draw(Graphics2D g) {
		if(bullet == null)
			return;
		g.drawImage(imageLoader.loadImage("/OOP_Project/images/LazerLastForm.png"), (int) getxPos(),(int) getyPos(), 30, 30, null);
