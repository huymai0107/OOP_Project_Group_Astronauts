...
public class LazerUpgraded extends PlayerWeaponType{
	...
	public LazerUpgraded(double xPos, double yPos){
		...
		this.bullet = new Rectangle((int) getxPos(),(int) getyPos(), 15, 15);
	}
	...
	public void draw(Graphics2D g) {
		if(bullet == null)
			return;
		g.drawImage(imageLoader.loadImage("/OOP_Project/images/LazerUpgraded.png"), (int) getxPos(),(int) getyPos(), 20, 20, null);
